...
Vue 3 SPA for browsing vessel trips and submitting new position reports. Talks to the [Vessel Positions API](https://github.com/alexandrosgialantzis/Vessels-pos-api).
